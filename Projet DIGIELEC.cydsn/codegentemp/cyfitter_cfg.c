...
#define BS_UDB_0_1_0_CONFIG_VAL ((const uint8 CYFAR *)0x4800055Cu)

/* IOPINS0_0 Address: CYREG_PRT0_DM0 Size (bytes): 8 */
#define BS_IOPINS0_0_VAL ((const uint8 CYFAR *)0x480005DCu)

/* IOPINS0_7 Address: CYREG_PRT12_DM0 Size (bytes): 8 */
#define BS_IOPINS0_7_VAL ((const uint8 CYFAR *)0x480005E4u)

/* IOPINS0_8 Address: CYREG_PRT15_DR Size (bytes): 10 */
#define BS_IOPINS0_8_VAL ((const uint8 CYFAR *)0x480005ECu)
...
#define BS_IOPINS0_3_VAL ((const uint8 CYFAR *)0x4800060Cu)
...
static void ClockSetup(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)(CYREG_CLKDIST_DCFG1_CFG0), 0x0013u);
...
uint8 CYXDATA * const CYCODE ADC_POTENTIOMETRE_AMux__addrTable[2] = {
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE ADC_POTENTIOMETRE_AMux__maskTable[2] = {
	0x40u, 
	0x00u, 
};

/*******************************************************************************
* Function Name: ADC_POTENTIOMETRE_AMux_Set
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void ADC_POTENTIOMETRE_AMux_Set(uint8 channel)
{
	if (channel < 2)
	{
		*ADC_POTENTIOMETRE_AMux__addrTable[channel] |= ADC_POTENTIOMETRE_AMux__maskTable[channel];
	}
}

/*******************************************************************************
* Function Name: ADC_POTENTIOMETRE_AMux_Unset
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void ADC_POTENTIOMETRE_AMux_Unset(uint8 channel)
{
	if (channel < 2)
	{
		*ADC_POTENTIOMETRE_AMux__addrTable[channel] &= (uint8)~ADC_POTENTIOMETRE_AMux__maskTable[channel];
	}
}

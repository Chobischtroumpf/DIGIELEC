...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=true, Compare1_8=false, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=1200, CompareValue2=63, CONTROL3=0, ControlReg=true, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=0, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=24000, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=true, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=true, TermVisibility_kill=false, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=true, UDB8=false, UseControl=true, UseInterrupt=true, UseStatus=true, VerilogSectionReplacementString=sP16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=PWM_v3_30, CY_CONFIG_TITLE=PWM_GAUCHE, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM_GAUCHE, CY_INSTANCE_SHORT_NAME=PWM_GAUCHE, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=PWM_GAUCHE, )
module PWM_v3_30_2 (
    capture,
    clock,
    cmp_sel,
...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=true, Compare1_8=false, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=1200, CompareValue2=63, CONTROL3=0, ControlReg=true, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=0, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=24000, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=true, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=true, TermVisibility_kill=false, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=true, UDB8=false, UseControl=true, UseInterrupt=true, UseStatus=true, VerilogSectionReplacementString=sP16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=PWM_v3_30, CY_CONFIG_TITLE=PWM_DROITE, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM_DROITE, CY_INSTANCE_SHORT_NAME=PWM_DROITE, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=PWM_DROITE, )
module PWM_v3_30_3 (
    capture,
    clock,
    cmp_sel,
...
module ADC_DelSig_v3_30_5 (
	...
	cy_clock_v1_0
		#(.id("8730d96d-0767-4e14-9f3f-f7e43ca746f7/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("8730d96d-0767-4e14-9f3f-f7e43ca746f7/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
		  .period("1562500000"),
		  .is_direct(0),
...
module CharLCD_v2_20_6 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("5990b15c-e3c2-4f6f-b18e-db6e4e1d00f3/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
    ...
    UART_v2_50_1 UART_1 (
        ...
        .rx_clk(Net_177),
        .rx_data(Net_178),
        .rx_interrupt(Net_179),
        .tx(Net_9),
        .tx_clk(Net_180),
        .tx_data(Net_181),
        .tx_en(Net_182),
        .tx_interrupt(Net_183));
	...
	cy_psoc3_pins_v1_10
		#(.id("a792f7f6-cf82-4a96-8e39-e0ffa3ce0f99"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("141f024d-be5a-4afa-b097-052b3e1036dc"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("b09a15a7-488d-46da-8b51-6a3d16210b0f"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("4a1f4579-e575-4436-b33a-a267b2ca5bb3"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("75e1e289-7df4-42f2-ab5d-675ba7c2beba"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    PWM_v3_30_2 PWM_GAUCHE (
        ...
        .tc(Net_224),
        .trigger(1'b0));
    defparam PWM_GAUCHE.Resolution = 16;

    PWM_v3_30_3 PWM_DROITE (
        .capture(1'b0),
        .clock(Net_130),
        .cmp_sel(1'b0),
        .enable(1'b1),
        ...
        .tc(Net_170),
        .trigger(1'b0));
    defparam PWM_DROITE.Resolution = 16;


	cy_clock_v1_0
		#(.id("2cf5d0f2-c103-46de-b04d-60a9c0d14c98"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(20),
		  .period("0"),
		  .is_direct(0),
	...
	cy_clock_v1_0
		#(.id("48601184-38b4-40e2-b9b9-98dc5d92669e"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(20),
		  .period("0"),
		  .is_direct(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("040955d3-d4b7-40ce-965c-79750532c89c"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("9f47dc66-ad8f-4760-b3a6-ab2298e00491"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("56fb632b-129a-4895-84f5-eb12eee44102"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("20eb9985-6673-4819-bd23-a6a78c69ae6d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("fa5635ad-3b2a-48ca-81cc-74edc2c62e13"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__SWITCH_2_net;
	wire [0:0] tmpFB_0__SWITCH_2_net;
	wire [0:0] tmpIO_0__SWITCH_2_net;
	wire [0:0] tmpINTERRUPT_0__SWITCH_2_net;
	electrical [0:0] tmpSIOVREF__SWITCH_2_net;

	cy_psoc3_pins_v1_10
		#(.id("e6aaff7b-caa3-4e3d-8c88-e4ce5bb3f603"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		SWITCH_2
		 (.oe(tmpOE__SWITCH_2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SWITCH_2_net[0:0]}),
		  .io({tmpIO_0__SWITCH_2_net[0:0]}),
		  .siovref(tmpSIOVREF__SWITCH_2_net),
		  .interrupt({tmpINTERRUPT_0__SWITCH_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SWITCH_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__SWITCH_3_net;
	wire [0:0] tmpFB_0__SWITCH_3_net;
	wire [0:0] tmpIO_0__SWITCH_3_net;
	wire [0:0] tmpINTERRUPT_0__SWITCH_3_net;
	electrical [0:0] tmpSIOVREF__SWITCH_3_net;

	cy_psoc3_pins_v1_10
		#(.id("9f942e28-6a14-4da0-af8c-0eef174659b4"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		SWITCH_3
		 (.oe(tmpOE__SWITCH_3_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SWITCH_3_net[0:0]}),
		  .io({tmpIO_0__SWITCH_3_net[0:0]}),
		  .siovref(tmpSIOVREF__SWITCH_3_net),
		  .interrupt({tmpINTERRUPT_0__SWITCH_3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SWITCH_3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__SWITCH_4_net;
	wire [0:0] tmpFB_0__SWITCH_4_net;
	wire [0:0] tmpIO_0__SWITCH_4_net;
	wire [0:0] tmpINTERRUPT_0__SWITCH_4_net;
	electrical [0:0] tmpSIOVREF__SWITCH_4_net;

	cy_psoc3_pins_v1_10
		#(.id("2896685e-e4d1-4ece-a08e-401ced2f90d9"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		SWITCH_4
		 (.oe(tmpOE__SWITCH_4_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SWITCH_4_net[0:0]}),
		  .io({tmpIO_0__SWITCH_4_net[0:0]}),
		  .siovref(tmpSIOVREF__SWITCH_4_net),
		  .interrupt({tmpINTERRUPT_0__SWITCH_4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SWITCH_4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    ADC_DelSig_v3_30_5 ADC_POTENTIOMETRE (
        .aclk(1'b0),
        .eoc(Net_268),
        .mi(1'b0),
        .nVref(Net_270),
	...
	wire [0:0] tmpOE__PIN_POTENTIOMETER_net;
	wire [0:0] tmpFB_0__PIN_POTENTIOMETER_net;
	wire [0:0] tmpIO_0__PIN_POTENTIOMETER_net;
	wire [0:0] tmpINTERRUPT_0__PIN_POTENTIOMETER_net;
	electrical [0:0] tmpSIOVREF__PIN_POTENTIOMETER_net;

	cy_psoc3_pins_v1_10
		#(.id("451dfd89-98e6-422e-b6bc-94778ca40336"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PIN_POTENTIOMETER
		 (.oe(tmpOE__PIN_POTENTIOMETER_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PIN_POTENTIOMETER_net[0:0]}),
		  .analog({Net_339}),
		  .io({tmpIO_0__PIN_POTENTIOMETER_net[0:0]}),
		  .siovref(tmpSIOVREF__PIN_POTENTIOMETER_net),
		  .interrupt({tmpINTERRUPT_0__PIN_POTENTIOMETER_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PIN_POTENTIOMETER_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    CharLCD_v2_20_6 LCD_Char_1 ();

	wire [0:0] tmpOE__PIN_SERVO_2_net;
	wire [0:0] tmpFB_0__PIN_SERVO_2_net;
	wire [0:0] tmpIO_0__PIN_SERVO_2_net;
	wire [0:0] tmpINTERRUPT_0__PIN_SERVO_2_net;
	electrical [0:0] tmpSIOVREF__PIN_SERVO_2_net;

	cy_psoc3_pins_v1_10
		#(.id("3531295b-ee36-4240-9d59-edd54e87ee7a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PIN_SERVO_2
		 (.oe(tmpOE__PIN_SERVO_2_net),
		  .y({Net_220}),
		  .fb({tmpFB_0__PIN_SERVO_2_net[0:0]}),
		  .io({tmpIO_0__PIN_SERVO_2_net[0:0]}),
		  .siovref(tmpSIOVREF__PIN_SERVO_2_net),
		  .interrupt({tmpINTERRUPT_0__PIN_SERVO_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PIN_SERVO_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PIN_SERVO_1_net;
	wire [0:0] tmpFB_0__PIN_SERVO_1_net;
	wire [0:0] tmpIO_0__PIN_SERVO_1_net;
	wire [0:0] tmpINTERRUPT_0__PIN_SERVO_1_net;
	electrical [0:0] tmpSIOVREF__PIN_SERVO_1_net;

	cy_psoc3_pins_v1_10
		#(.id("08a88a56-dcf2-41af-9df7-c2f8dd34ab3b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PIN_SERVO_1
		 (.oe(tmpOE__PIN_SERVO_1_net),
		  .y({Net_166}),
		  .fb({tmpFB_0__PIN_SERVO_1_net[0:0]}),
		  .io({tmpIO_0__PIN_SERVO_1_net[0:0]}),
		  .siovref(tmpSIOVREF__PIN_SERVO_1_net),
		  .interrupt({tmpINTERRUPT_0__PIN_SERVO_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PIN_SERVO_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
